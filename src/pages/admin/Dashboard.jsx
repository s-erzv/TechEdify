...
export default function AdminDashboard() {
  ...
  const [currentTheme, setCurrentTheme] = useState('light'); // <--- State baru untuk tema

  // <--- useEffect baru untuk mendeteksi tema dan MutationObserver
  useEffect(() => {
    const checkTheme = () => {
    ...
    // Buat MutationObserver untuk bereaksi terhadap perubahan kelas pada elemen html
  ...
  // <--- Fungsi baru untuk beralih tema
  const toggleTheme = () => {
    if (document.documentElement.classList.contains('dark')) {
      document.documentElement.classList.remove('dark');
      localStorage.setItem('theme', 'light'); // Opsional: simpan preferensi tema
    } else {
      document.documentElement.classList.add('dark');
      localStorage.setItem('theme', 'dark'); // Opsional: simpan preferensi tema
    }
    // currentTheme akan diperbarui secara otomatis oleh MutationObserver
  };
